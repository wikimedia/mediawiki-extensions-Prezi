...
class PreziTag {
	...
	<object id="prezi_' . $id . '" name="prezi_' . $id . '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="' . $width . '" height="'. $height . '"><param name="movie" value="http://prezi.com/bin/preziloader.swf"/><param name="allowfullscreen" value="true"/><param name="allowscriptaccess" value="always"/><param name="bgcolor" value="' . $backgroundColor . '"/><param name="flashvars" value="prezi_id=' . $id . '&amp;lock_to_path=0&amp;color=' . $color . '&amp;autoplay=no&amp;autohide_ctrls=0"/><embed id="preziEmbed_' . $id . '" name="preziEmbed_' . $id . '" src="http://prezi.com/bin/preziloader.swf" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="' . $width . '" height="' . $height . '" bgcolor="' . $backgroundColor . '" flashvars="prezi_id=' . $id . '&amp;lock_to_path=0&amp;color=' . $color . '&amp;autoplay=no&amp;autohide_ctrls=0"></embed></object><div class="prezi-player-links" style="text-align: center;"><p>' . $linkGobbledyGoo . '</p></div></div>';
	}
